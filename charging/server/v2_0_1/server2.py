...
async def main():
    ...
    server_test = await websockets.serve(
        on_connect, "fe80::e3a6:46e4:bff9:fb8e%ens33", 9001, subprotocols=[Subprotocol("ocpp2.0.1")]
    )

    # Start websocket with callback function
    server = await websockets.serve(
        #on_connect, "::", 9000, subprotocols=[Subprotocol("ocpp2.0.1")]
        on_connect_tls, "fe80::e3a6:46e4:bff9:fb8e%ens33", 9000, subprotocols=[Subprotocol("ocpp2.0.1")], ssl = context
    )
