...
os.environ['http_proxy'] = 'http://192.168.10.128:8080'
os.environ['https_proxy'] = 'https://192.168.10.128:8080'
...
async def launch_client(
    ...
    async with websockets.connect(
            f"ws://{server}:{port}/{serial_number}", subprotocols=[Subprotocol("ocpp2.0")]
