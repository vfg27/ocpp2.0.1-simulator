...
if VERSION == 'v2_0_1':
    from charging.client.v2_0_1.client2 import launch_client, get_host_and_port, ChargePointClient, wait_for_button_press
elif VERSION == 'v1_6':
    from charging.client.v1_6.client2 import launch_client, get_host_and_port, ChargePointClient, wait_for_button_press
